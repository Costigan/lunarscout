...
namespace moonlib.util
{
    ...
    {
        static byte[] PNG_IDENTIFIER = { 0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A };
        ...
        static int FindChunk(byte[] data, String chunkName)
        {
        ...
        static int GetChunkDataLength(byte[] data, int offset)
        {
